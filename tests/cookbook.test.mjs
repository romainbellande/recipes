...
test('builds a Cookbook with its Recipes and cook mode', async () => {
	...
	for (const text of ['Apple crumble', 'Tender apples under a buttery oat topping.', '1 hr · serves 6 · dessert · make-ahead', 'Enter cook mode', 'Exit cook mode', 'Current step']) {
